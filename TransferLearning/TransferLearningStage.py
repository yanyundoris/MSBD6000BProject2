...
def main(_):
  ...
  if not ARGFLAGS.predict_only:
    ...
    # save_path = saver.save(sess, "/Users/yanyunliu/PycharmProjects/TensorFlowTutorial/TF_model.ckpt")
  ...
  if not img_list:
    ...
    prediction_result.to_csv('/Users/yanyunliu/PycharmProjects/TensorFlowTutorial/transfer_learning_predict', sep=' ', index=False)

    class_vectorDf = pd.DataFrame(class_vector_list)
    class_vectorDf.to_csv('/Users/yanyunliu/PycharmProjects/TensorFlowTutorial/transfer_learning_class_vectorDf',
                             index=False)
